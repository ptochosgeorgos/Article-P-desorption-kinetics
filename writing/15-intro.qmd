...
1. **P-Intensity ($I$):** The thermodynamic energy state, or chemical activity, of P in the soil solution at any given moment. 
2. **P-Quantity or Capacity ($Q$):** The physical mass of solid-phase P that is readily desorbable and can replenish the soil solution. 
...
- **Olsen P ($NaHCO_3$, pH 8.5):** Measures desorbable P. The high concentration of bicarbonate ions outcompetes orthophosphate for adsorption sites on soil surfaces [@Olsen1954].
- **P-AAE10 (Ammonium Acetate EDTA, pH 4.65):** A strong extractant that attacks both sorbed and precipitated P forms. EDTA chelates background cations, actively dissolving apatites, while the acetate buffer facilitates desorption [@FAL1996Methodenbuch].
