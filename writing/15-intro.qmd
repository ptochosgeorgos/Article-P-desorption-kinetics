...
To clarify this transition from static operational testing to dynamic modeling, @tbl-terminology maps the fundamental theoretical components of soil P availability to their respective analytical proxies.

| Approach / Framework | Intensity Factor | Quantity (Capacity) Factor | Kinetic Factor |
| :--- | :--- | :--- | :--- |
| **Theoretical Concept (@Frossard2000Processes)** | P concentration in the soil solution at a given moment | The pool of solid-phase P that can replenish the solution | The rate of P transfer from the solid to the liquid phase |
| **Traditional / Static Proxy (GRUD)** | $P_{CO_2}$ (Water-soluble P) | $P_{AAE10}$ (Chelate-extractable P) | *Not Measured* |
| **Dynamic / Kinetic Proxy (This Study)** | Initial P Flux ($J_0$) | Equilibrium Desorbable P ($P_{desorb}$) | Desorption Rate Constant ($k$) |
