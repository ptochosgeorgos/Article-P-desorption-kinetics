...
##     end
## 
##     subgraph Phase_3 ["Phase 3: The Kinetic Crossing"]
...
ptf_results_cons <- bind_rows(
    get_metrics_lmer(ptf_cons_raw, "Conservative Agro (Raw P_CO2)", D_ptf_cons, "ln_P_AAE"),
...
df_yield_metrics <- dplyr::bind_rows(list(
    get_metrics_nlme(m_yield_raw_co2, "Yield ~ Raw P_CO2", D_Yield, "Relative_Yield"),
