...
# ---------------------------------------------------------
D_Long_Agro <- D_Long |> filter(is.finite(z_inv_b_agro), !is.na(z_fert_N), !is.na(z_Temp_Anom)) |> droplevels()
D_Long_Thm <- D_Long |> filter(is.finite(z_inv_b_agro), !is.na(z_fert_N), !is.na(z_Temp_Anom)) |> droplevels()
D_Long_Cons <- D_Long |> filter(is.finite(z_inv_b_cons), !is.na(z_fert_N), !is.na(z_Temp_Anom)) |> droplevels()
