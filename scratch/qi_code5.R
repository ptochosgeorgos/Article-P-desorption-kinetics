...
D_Yield <- D_ready |>
    ...
    mutate(
        n_pred_cons = C_cons("ln_P_CO2") +
            get_int_cons("ln_P_CO2", "z_ln_FineTexture") * z_ln_FineTexture +
            get_int_cons("ln_P_CO2", "z_pH") * z_pH +
            get_int_cons("ln_P_CO2", "z_ln_Ca") * z_ln_Ca +
            get_int_cons("ln_P_CO2", "z_ln_Mg") * z_ln_Mg +
            get_int_cons("ln_P_CO2", "z_ln_K") * z_ln_K +
            get_int_cons("ln_P_CO2", "z_ln_Corg") * z_ln_Corg,
        ln_K_pred_cons = C_cons("(Intercept)") + C_cons("z_ln_FineTexture") * z_ln_FineTexture + C_cons("z_pH") * z_pH + C_cons("z_ln_Ca") * z_ln_Ca + C_cons("z_ln_Mg") * z_ln_Mg + C_cons("z_ln_K") * z_ln_K + C_cons("z_ln_Corg") * z_ln_Corg,
