...
When solved numerically for average Swiss conditions ($c_{eff} \approx 4.3$, $E_{base} \approx 0.81$, $K_m \approx 0.026$), the true theoretical Critical Intensity ($I_{crit}$) evaluates to **$0.00006 \text{ mg/L}$**. 
