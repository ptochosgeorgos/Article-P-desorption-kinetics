...
## The Piper-Steenbjerg Paradox & Sorption Capacity { .scrollable .smaller }

<details>
<summary>The Paradox Explained</summary>
...
- **Carbon Dilution:** P-starved plants dilute their tissue P concentration when growth resumes.
- **Blind Diagnostics:** A low $C_P$ does not always mean low soil supply.
- **The Solution:** We must abandon simple empirical concentrations and physically model the absolute mass-flux: **Uptake ($Yield \times C_P$)**.
...
## Physical Buffer Collapse { .interactive-slide .smaller }
...
## Systematic Bias in Fertilizer Recommendations { .smaller }
...
## The Calcareous pH Artifact in AAE10 { .smaller }
